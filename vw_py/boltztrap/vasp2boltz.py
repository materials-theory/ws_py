...
def write_bandstructure_boltztrap(bandstructure, filename="boltztrap", unit='Ry', yscale=None, E_Fermi_zero=True, pathname='./', ktrafo=None, runBoltz=False):
...
def write_structure_boltztrap(ao, filename="boltztrap", pathname='./'):
...
def write_intrans_boltztrap(filename='boltztrap', E_Fermi=0.0, n_electrons=1.0, boltzdir='./', boltz_generic=True):
    filename = str(filename + ".intrans")
