...
from vw_py.ElectronicStructure.dos import Densityofstates


# TODO: re-write density-of-states line tracing part
class Plotter(object):
    ...
    def plotdos(self, fermi, combine):
        ...
        if self.dosdata.numpdos == 4:
        ...
        elif self.dosdata.numpdos == 19:
            for x in atom.keys():
                sumname = ("E_sumDOS_" + x + "" + self.input_name + " "
                           + "sumDOS_" + x + "_s_up" + self.input_name + " "
                           + "sumDOS_" + x + "_s_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_px_up" + self.input_name + " "
                           + "sumDOS_" + x + "_px_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_py_up" + self.input_name + " "
                           + "sumDOS_" + x + "_py_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_up" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_up" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_up" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_up" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_dw" + self.input_name + " "
                           + "sumDOS_" + x + "_dxz_up" + self.input_name + " "
                ...
                for y in range(int(atom[x])):
                    tmpname = ("E_pDOS_" + x + str(y + 1) + "" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_s_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_s_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_up" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_dw" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxz_up" + self.input_name + " "
            ...
            for x in atom.keys():
                sumname = ("E_sumDOS_" + x + "" + self.input_name + " "
                           ...
                           + "sumDOS_" + x + "_s_my" + self.input_name + " "
                           + "sumDOS_" + x + "_s_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_px_t" + self.input_name + " "
                           + "sumDOS_" + x + "_px_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_px_my" + self.input_name + " "
                           + "sumDOS_" + x + "_px_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_py_t" + self.input_name + " "
                           + "sumDOS_" + x + "_py_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_py_my" + self.input_name + " "
                           + "sumDOS_" + x + "_py_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_t" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_my" + self.input_name + " "
                           + "sumDOS_" + x + "_pz_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_t" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_my" + self.input_name + " "
                           + "sumDOS_" + x + "_dxy_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_t" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_my" + self.input_name + " "
                           + "sumDOS_" + x + "_dyz_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_t" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_my" + self.input_name + " "
                           + "sumDOS_" + x + "_dz2_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_dxz_t" + self.input_name + " "
                           + "sumDOS_" + x + "_dxz_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_dxz_my" + self.input_name + " "
                           + "sumDOS_" + x + "_dxz_mz" + self.input_name + " "
                           + "sumDOS_" + x + "_dx2_t" + self.input_name + " "
                           + "sumDOS_" + x + "_dx2_mx" + self.input_name + " "
                           + "sumDOS_" + x + "_dx2_my" + self.input_name + " "
                           + "sumDOS_" + x + "_dx2_mz" + self.input_name + " "
                           + "sumDOS_" + x + "" + self.input_name + " "
                           )
                sumdis = ("X Display "
                          + "sumDOS_" + x + "_s_t" + self.input_name + " "
                ...
                for y in range(int(atom[x])):
                    tmpname = ("E_pDOS_" + x + str(y + 1) + "" + self.input_name + " "
                               ...
                               + "pDOS_" + x + str(y + 1) + "_s_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_s_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_px_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_py_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_pz_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxy_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dyz_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dz2_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxz_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxz_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxz_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dxz_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dx2_t" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dx2_mx" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dx2_my" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "_dx2_mz" + self.input_name + " "
                               + "pDOS_" + x + str(y + 1) + "" + self.input_name + " "
                               )
                    tmpdisplay = ("X Display "
                                  + "pDOS_" + x + str(y + 1) + "_s_t" + self.input_name + " "
